  ...
  return (
    <>
      <div>
        {/* 
            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                ...
                <div className="flex items-center justify-start">
                    ...
                    <img src={logoDaval} className="h-8 mr-3" alt="" />
                ...
                <div className="flex items-center">
                    <div className="flex items-center ml-3">
                        ...
                        <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            ...
                            <img className="w-8 h-8 rounded-full" src={alamine} alt="user photo"/>
                        </button>
                        </div>
        ...
        <aside
          id="logo-sidebar"
          className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-900 dark:border-gray-600"
          aria-label="Sidebar"
        >
            ...
            <ul className="space-y-2">
              <Link to="/Dashboard">
                <div className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  <RiDashboardFill className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white" />
                  <span className="ml-3">Tableau de bord</span>
                </div>
              </Link>
              <Link to="/UsersUI">
                <div className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  <CiUser className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white" />
